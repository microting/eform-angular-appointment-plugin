...
# Define paths
src_base = os.path.join("Documents", "workspace", "microting", "eform-angular-appointment-plugin")
dst_base = os.path.join("Documents", "workspace", "microting", "eform-angular-frontend")

# Remove and copy directories
paths = [
    (os.path.join("eform-client", "src", "app", "plugins", "modules", "appointment-pn"),
     os.path.join("eform-client", "src", "app", "plugins", "modules", "appointment-pn")),
    (os.path.join("eFormAPI", "Plugins", "Appointment.Pn"),
     os.path.join("eFormAPI", "Plugins", "Appointment.Pn")),
]
...
test_files_to_remove = [
    os.path.join("eform-client", "e2e", "Tests", "appointment-settings"),
    os.path.join("eform-client", "e2e", "Tests", "appointment-general"),
    os.path.join("eform-client", "e2e", "Page objects", "Appointment"),
